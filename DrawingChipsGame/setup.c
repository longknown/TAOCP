...
static int gMode;
static int gIsFirst;
static char gPlayer1[MAXNAME+1];
static char gPlayer2[MAXNAME+1];
static int gPileSize;
 ...
 */
static int read_input_number(int *num);
static int get_pile_size(void);
static int get_is_first(void);
        ...
        if(read_input_number(&mode) == 1) {
            switch(mode) {
                case 1:
                    ...
                    printf("Hello, %s, choose the number of piles to play (>= 0):\n"
                            ">>> ", player1);
                    gPileSize = get_pile_size();
                    printf("Do you want to play first? [Y/N]\n"
                            ">>> ");
                    gIsFirst = get_is_first();
                    gMode = mode;
                    goto setup;
                ...
                case 2:
                    ...
                    printf("Hello, %s and %s, choose the number of piles to play (>= 0):\n"
                            ">>> ", player1, player2);
                    gPileSize = get_pile_size();
                    gMode = mode;
                    goto setup;
